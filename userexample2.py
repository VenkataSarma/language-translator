...
class LanguageTranslatorApp:
    def __init__(self, root):
        ...
        self.label.pack()
        def active():
            import userexample.py
            
        self.button=Button(root,text="speech translation",command=active)
        self.button.pack()
        def hello():
            import tkinterpdf2.py
            
        self.button=Button(root,text="upload pdf here",command=hello)
        self.button.pack()
    ...
    def translate_to_language(self, source_text, target_language):
        ...
        translation = translator.translate(source_text, src='english', dest=target_language)
